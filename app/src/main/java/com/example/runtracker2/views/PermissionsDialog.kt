...
class LocationPermissionTextProvider: PermissionTextProvider{
    override fun getDescription(isPermanentlyDeclined: Boolean): String {
        return if (isPermanentlyDeclined){
            ...
            "This app needs access to your location in order to track you runs."
        }
    }
...
class PostNotificationPermissionTextProvider: PermissionTextProvider{
    override fun getDescription(isPermanentlyDeclined: Boolean): String {
        return if (isPermanentlyDeclined){
            ...
            "This app needs permission to post notification in order to track you runs while the app" +
